...
rem ===========================================================================
rem  Abode Night View - produce dist\AbodeNightView.exe
rem ---------------------------------------------------------------------------
rem  A thin wrapper so the release build is one double-click on a normal
rem  machine. It just runs build-release.ps1, which is the canonical script.
rem
